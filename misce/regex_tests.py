...
generic_regexs['upto4dig'] = '^\d{1,4}$'
generic_regexs['upto5dig'] = '^\d{1,5}$'
generic_regexs['upto6dig'] = '^\d{1,6}$'
generic_regexs['upto7dig'] = '^\d{1,7}$'
generic_regexs['form_name'] = '^[A-Z]{4,9}$'
generic_regexs['form_call'] = ['^\d[A-Z][A-Z]$',
             '^(?=.*\d?)(?=.*[A-A])[0-9A-Z]{4,4}$',
             '^[A-Z]\d[A-Z]\d','^[A-Z]\d\d[A-Z]$',
             '^\d[A-Z]\d[A-Z]$','^[A-Z]{4,4}\d$',
             '^[A-Z]\d[A-Z][A-Z]\d$',
             '^\d[A-Z][A-Z][A-Z]\d$']
generic_regexs['form_call_lc'] = ['^\d[a-z][a-z]$',
             '^(?=.*\d?)(?=.*[A-A])[0-9a-z]{4,4}$',
             '^[a-z]\d[a-z]\d','^[a-z]\d\d[a-z]$',
             '^\d[a-z]\d[a-z]$','^[a-z]{4,4}\d$',
             '^[a-z]\d[a-z][a-z]\d$',
...
generic_regexs['form_cman'] = '^[A-Z]{4,4}\d$'
